...
This is the Dyad scale tag from the Loop Tongue, made as concrete as it gets: a Dyad, in this fuller sense, is what it looks like when a <a class="concept-link" href="/concept/third-thing/">Third Thing</a> at exactly two people's scale becomes stable and durable enough to be a pattern in its own right — not just a Skein-thread among others, but the whole fabric, for those two.
...
**A Dyad can become a <a class="concept-link" href="/concept/the-braid/">Braid</a> too, once it's visible to anyone else.** A relationship other people know and describe — "the stable ones," "the couple who never fights" — has a real Dyad underneath it and a public name riding alongside it, the same fusion Part Two's chapter on the Skein calls a Braid, one scale down. The risk is identical in shape: energy that should go into the harder, less photogenic maintenance the relationship actually needs starts going into keeping up the appearance the name implies instead. The same test applies here as anywhere else a Braid can form: when the reputation is threatened — a bad public fight, a hard year neither of you can hide — does the response protect what other people think you are, or protect the actual relationship? A real Dyad can survive looking imperfect from outside. Only the label needs it to look otherwise.
