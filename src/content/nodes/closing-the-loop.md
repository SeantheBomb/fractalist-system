...
Suffering runs through all three the same way, worth naming once here rather than expanding on: it's often the friction that reveals what a scale needed and wasn't getting. Held with the distance Chapter 4 already taught you — pain observed rather than pain obeyed — it converts into something usable instead of curdling into bitterness. That capacity has a name, hope, and it's trainable the same way everything else here is: not a temperament some people are born with more of, but a loop, practiced. Whatever gets built this way doesn't stay contained at Self scale, any more than a <a class="concept-link" href="/concept/local-rule/">Local Rule</a> stays contained to the loop you first thought you were running. It travels, the same way everything real in this book travels.
