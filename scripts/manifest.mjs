...
export const KINSHIPS = {
  ...
  skein: {
    ...
    intro: 'Eleven figures, each built from two Meetings that share a person. This is the mechanism by which a group stops being a list of people and becomes a thing in its own right.',
  },
  culture: {
