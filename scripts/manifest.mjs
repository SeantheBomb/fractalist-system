...
export const KINSHIPS = {
  ...
  dyad: {
    ...
    intro: 'Nineteen figures, each one two Currents running in two people. My loop, meeting yours, producing something neither of us brought — which is why each of these names two parents rather than standing alone.',
  },
  skein: {
    title: 'The Weaves',
    ring: 'The third ring — Skein.',
    intro: 'Ten figures, each built from two Meetings that share a person. This is the mechanism by which a group stops being a list of people and becomes a thing in its own right.',
  },
  culture: {
    title: 'The Long Forms',
    ring: 'The outermost drawable ring — Culture.',
    intro: 'Seven figures slow enough that no single life watches one complete a full turn. This tier sits three inference-layers deep, composed from Weaves rather than observed directly, and the book names it the most provisional part of the catalogue.',
  },
  cosmos: {
