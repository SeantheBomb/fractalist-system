...
export const NODES = [
  ...
  {
    heading: '5. Bottom-Up or Nothing',
    slug: 'bottom-up-or-nothing',
    title: 'Bottom-Up or Nothing',
    part: 'part-one',
    summary: 'Fractalism cannot have a central authority, the same way a circle cannot have corners — and the line between naming a pattern and handing someone a verdict.',
    related: ['the-loop-runs-you', 'four-pillars', 'a-word-on-belief'],
  },
  {
  ...
  {
    heading: '8. Complicated or Complex',
  ...
  {
    heading: '9. Position, Speed, Acceleration',
  ...
  {
    heading: '10. Where It Comes From',
  ...
  {
    heading: '11. A Word on Belief Itself',
  ...
  },
  {
    ...
    title: 'The Stall',
    part: 'part-two',
    summary: 'A stall has exactly three possible causes — capacity, understanding, or want — and each has its own fix that does not substitute for the others.',
    related: ['finding-your-local-rule', 'the-compost-heap', 'finding-your-leverage-point'],
  },
  {
    heading: '8. Starting Is Expensive, Staying Is Cheap',
    slug: 'starting-is-expensive',
    title: 'Starting Is Expensive, Staying Is Cheap',
    part: 'part-two',
    summary: 'Why the same practice costs some people almost nothing and others everything: building momentum from a standing start is a different job than holding speed you already have.',
    related: ['the-stall', 'reading-your-own-cycle', 'daily-practices'],
  },
  {
    heading: '9. Finding Your Leverage Point',
  ...
  {
    heading: '10. Fractal Resistance, Practiced',
  ...
  {
    heading: '15. Do I Understand You Well Enough?',
  ...
  },
  {
    ...
    title: 'Presence',
    part: 'part-two',
    summary: 'A conversation is two people each building a model of the other while being modelled themselves — why an accurate reading lands as an attack until the other person can tell you\'re actually there.',
    related: ['do-i-understand-you', 'the-trust-triangle', 'receiving'],
  },
  {
    heading: '17. Receiving',
    slug: 'receiving',
    title: 'Receiving',
    part: 'part-two',
    summary: 'Six things you can do with what arrives at you — fighting back, withdrawing, parley, doing nothing, withholding, blending — and the test that tells a stable standoff from ordinary avoidance.',
    related: ['presence', 'the-trust-triangle', 'the-tested-price'],
  },
  {
    heading: '18. Group Practice',
    slug: 'group-practice',
  ...
  },
  {
    ...
    related: ['world-kin', 'fractalism-collective', 'the-shared-name'],
  },
  {
    heading: '5. The World-Kin',
    slug: 'world-kin',
    title: 'The World-Kin',
    part: 'part-five',
    summary: 'Three figures, and only three, derived rather than chosen: two Culture-Kin sharing a Skein-Kin. The last tier where a push still reaches.',
    related: ['infinite-boundary-scale', 'culture-kin', 'fractalism-collective'],
  },
  {
    heading: '6. The Infinite Boundary — Cosmos Scale',
  ...
  {
    heading: '7. What This Catalogue Is Not',
    slug: 'catalogue-limits',
    title: 'What This Catalogue Is Not',
    part: 'part-five',
    summary: 'Fifty-two figures is a taxonomy, not a pantheon. Most people find four or five of them run their lives and the rest describe other people — that\'s the correct outcome.',
    related: ['going-to-ground', 'open-questions', 'what-a-third-is'],
  },
  {
    heading: '8. Going to Ground',
  ...
  },
  {
    ...
    title: 'The Deck',
    part: 'part-six',
    summary: 'The full working deck: fifty-two drawable figures across five kinships, each carrying two readings — plus one figure that\'s never drawn at all.',
...
export const KINSHIPS = {
  ...
  world: {
    title: 'The World-Kin',
    ring: 'The outermost drawable ring — World, drawn only when the question is genuinely about the world.',
    intro: 'Three figures, and only three: run the rule two Culture-Kin sharing a Skein-Kin against the seven Culture figures, and it produces exactly these and no others. The last tier where a push still reaches — one further out, and leverage runs out entirely.',
  },
  cosmos: {
    title: 'The Cosmos-Kin',
    ring: 'Never drawn — the boundary the other five rings already sit inside.',
...
export const THIRD_BLURBS = {
  ...
  'the-standing-account': 'A civilization tracking itself through a number so it can steer. It can let a society see itself well enough to build deliberately, or keep steering by a number that stopped tracking the thing while the thing is spent.',
  'second-nature': 'Structure built up so gradually and so well-fitted that nobody has to attend to it anymore. It can free a civilization to build on top of what already works, or get mistaken for the given world rather than a made one, and go unopposed for being invisible.',
  'the-set-course': 'A direction set early enough that everything downstream gets built on top of it. It can let generations build on a shared foundation, or lock a course in place, set by people no longer here to argue with.',
